...
```
  - **Possible problem: seems that this produces environemnt with numpy of correct version but newer numpy-base; might result import numpy to import wrong one!**
